...
:root {
  ...
  --bg: #fff;
  --max-w: 1100px;
  --font-display: 'larken', 'DM Serif Display', Georgia, serif;
...
|------|--------|-------|---------|-------|
| Larken | Adobe Fonts | Headlines & display | 400 | Letter-spacing: -0.02em. Warm editorial serif. Falls back to DM Serif Display (Google Fonts) if Typekit is unavailable. |
